        ...
        <div className="col-lg-12">
          ...
          <nav aria-label="Page navigation example">
            <ul class="pagination">
              <li class="page-item">
              {
                  currentPage !==0 ?<button class="page-link" onClick={()=> previous()} >Previous</button> : null
                }
              </li>
              ...
              {[...Array(data.length/perPage)].map((page,index) => {
                return (
                  <li class="page-item">
                    <button className={`page-link ${currentPage===index? 'active':null}`} onClick={()=> pagenate(index)}>
                    {index+1}
                    </button>
                  </li>
            ...
            }} style={{width:75}} className='form-control'>
...
// {[...Array(data.length/5)].map((page,index) => {
//   return (
//     <li class="page-item">
//       <button className={`page-link ${currentPage===index? 'active':null}`} onClick={()=> pagenate(index)}>
//       {index+1}
